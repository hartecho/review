...
export const roughInTagDescriptions = {
  ASB: "Asbestos Abatement",
  CAR: "Carpentry and Woodwork",
  CON: "Concrete and Masonry",
  DEM: "Demolition",
...
export const finishTagDescriptions = {
  AV: "Audio-Visual Installations",
  CAB: "Cabinets",
  CLE: "Cleaners",
  CLG: "Ceiling Systems",
...
export const roughInSupplierTagDescriptions = {
...
export const finishSupplierTagDescriptions = {
  ACOUST: "Acoustic Materials",
  CAB: "Cabinets",
  CABL: "Cabling and Networking",
  DRY: "Drywall and Plaster Materials",
  ...
  SURF: "Surface Preparation and Coatings",
  TAP: "Tapes and Adhesives",
  WNDW: "Windows and Doors",
};

export const generalSupplierTagDescriptions = {
  SAF: "Safety Equipment and PPE",
  TOOLS: "Tools and Equipment Rental",
  WARE: "Warehouse Setup",
  OTH: "Other",
